  ...
  function g(t, a) {
    ...
    if (t.classList.contains(y.tabButton)) {
      ...
      if (
        ...
        c.classList.add(y.tabButtonActive),
        !o)
      ) {
        if (m.persist) {
          var d = (s
              ? Array.apply(null, s.querySelectorAll('.'.concat(y.tabBlock)))
              : []
            ).indexOf(r),
        ...
        if (m.sync) {
          var f = s
              ? Array.apply(
                  null,
                  s.querySelectorAll(
                    '.'.concat(y.tabButton, '[data-tab="').concat(e, '"]')
                  )
                )
              : [],
          ...
          f.forEach(function(t) {
            ...
            0 !== l.indexOf(e) &&
              (l.unshift(e), sessionStorage.setItem('*', JSON.stringify(l)));
        }
      }
    }
  }
  function s() {
    var t = (window.location.hash.match(/(?:id=)([^&]+)/) || [])[1],
      a =
        ...
        '.'
          .concat(y.tabBlock, ' #')
          .concat(-1 < t.indexOf('%') ? decodeURIComponent(t) : t);
    if (t && document.querySelector(a)) {
      ...
      if (c.closest) o = c.closest('.'.concat(y.tabContent));
        ...
        for (
          o = c.parentNode;
          o !== document.body && !o.classList.contains(''.concat(y.tabContent));
  ...
  window &&
    ...
    Object.keys(window.$docsify.tabs).forEach(function(t) {
      Object.prototype.hasOwnProperty.call(m, t) &&
        (m[t] = window.$docsify.tabs[t]);
    }),
    (window.$docsify.tabs.version = '1.4.4'),
    (m.tabComments || m.tabHeadings) &&
      (window.$docsify.plugins = [].concat(function(t, a) {
        var o = !1;
        t.beforeEach(function(t) {
          return (
            (o = p.tabBlockMarkup.test(t)) &&
              (t = (function(d) {
                for (
                  var b,
                    f,
                    o = d.match(p.codeMarkup) || [],
                    ...
                    l = m.theme
                      ? ''.concat(y.tabBlock, '--').concat(m.theme)
                      : '',
                    a = function() {
                      var o = b[0],
                        t = '',
                      ...
                      if (c || e) {
                        ...
                        for (
                          var i = function() {
                            var t = (f[2] || '[Tab]').trim(),
                              a = (f[3] || '').trim();
                            o = o.replace(f[0], function() {
                              return [
                                '\n'
                                  .concat(s, '\x3c!-- ')
                                  .concat(u, ' <button class="')
                                  .concat(y.tabButton, '" data-tab="')
                                  .concat(t.toLowerCase(), '">')
                                  .concat(t, '</button> --\x3e'),
                                '\n'
                                  .concat(s, '\x3c!-- ')
                                  .concat(u, ' <div class="')
                                  .concat(y.tabContent, '" data-tab-content="')
                                  .concat(t.toLowerCase(), '"> --\x3e'),
                                '\n\n'.concat(s).concat(a),
                                '\n\n'
                                  .concat(s, '\x3c!-- ')
                                  .concat(u, ' </div> --\x3e'),
                          ...
                          (f =
                            (m.tabComments
                              ? p.tabCommentMarkup.exec(o)
                              : null) ||
                            (m.tabHeadings
                              ? p.tabHeadingMarkup.exec(o)
                              : null));

                        )
                          i();
                      }
                      (o = (o = o.replace(r, function() {
                        return t;
                      })).replace(n, function() {
                        return a;
                      })),
                  ...
                  null !== (b = p.tabBlockMarkup.exec(d));
            ...
            o &&
              (t = (function(o) {
                for (
                  ...
                  null !== (c = p.commentReplaceMarkup.exec(o));
          ...
          t.doneEach(function() {
            var t, a, c, e;
            o &&
              ((t = document.querySelector('.'.concat(y.tabsContainer))),
              (a = t
                ? Array.apply(null, t.querySelectorAll('.'.concat(y.tabBlock)))
                : []),
              (c =
              ...
              a.forEach(function(a, t) {
                ...
                o ||
                    ...
                    (o = e
                      .map(function(t) {
                        return a.querySelector(
                          '.'.concat(y.tabButton, '[data-tab="').concat(t, '"]')
                        );
                      })
                      .filter(function(t) {
                        return t;
                  ...
                  !o &&
                    m.persist &&
                    (o = a.querySelector(
                      '.'.concat(y.tabButton, '[data-tab="').concat(c[t], '"]')
                    )),
                  (o = o || a.querySelector('.'.concat(y.tabButton))) &&
                    o.classList.add(y.tabButtonActive));
              }));
          }),
          t.mounted(function() {
